...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // CEK DUPLIKAT & SIMPAN
    $check = $conn->query("SELECT id FROM surat WHERE no_surat='$no_surat'");
    if ($check && $check->num_rows > 0) {
        flash("❌ Nomor surat sudah terdaftar!", "danger");
    } else {
        $stmt = $conn->prepare("INSERT INTO surat (no_surat, jenis_surat, bidang, pengirim, tanggal_kirim, tanggal_terima, perihal, disposisi, status, keterangan, file_surat) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
        $stmt->bind_param("sssssssssss", $no_surat, $jenis_surat, $bidang, $pengirim, $tanggal_kirim, $tanggal_terima, $perihal, $disposisi, $status, $keterangan, $file_surat);
        
        if ($stmt->execute()) {
            flash("✅ Surat berhasil ditambahkan!", "success");
...
<body>
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="tambah.php" class="nav-item active"><span class="icon"><i class="fas fa-plus-circle"></i></span> Tambah Surat</a>
    ...
    <div class="main-content">
        <div class="page-header">
            <div class="page-title">
                ...
                <div>
                    ...
                    <p>Isi formulir di bawah untuk menambah surat baru ke sistem</p>
                </div>
            </div>
        ...
        <div class="form-container">
            <div class="form-header">
                ...
                <h2>Formulir Penambahan Surat</h2>
            </div>
            ...
            <div class="form-body">
                ...
                <form method="POST" enctype="multipart/form-data" id="formSurat">
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <div class="input-wrapper">
                                <input type="text" name="no_surat" class="form-control" placeholder="SM/006/DP3A/2026" required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrapper">
                                <select name="jenis_surat" class="form-control" required>
                                    ...
                                    <option value="masuk"><i class="fas fa-arrow-down"></i> Surat Masuk</option>
                                    <option value="keluar"><i class="fas fa-arrow-up"></i> Surat Keluar</option>
                                </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrapper">
                                <select name="bidang" class="form-control" required>
                                    ...
                                    <option value="Perlindungan Khusus Anak">Perlindungan Khusus Anak</option>
                                    <option value="Perlindungan Perempuan">Perlindungan Perempuan</option>
                                    <option value="Pemenuhan Hak Anak">Pemenuhan Hak Anak</option>
                                    <option value="Kualitas Hidup Perempuan">Kualitas Hidup Perempuan</option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrapper">
                                <input type="text" name="pengirim" class="form-control" placeholder="Nama instansi/perorangan" required>
                    ...
                    <div class="form-group full-width">
                        ...
                        <div class="input-wrapper">
                            <textarea name="perihal" class="form-control" placeholder="Tulis perihal surat secara detail..." required></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <div class="input-wrapper">
                                <input type="text" name="disposisi" class="form-control" placeholder="Nama penerima disposisi">
                    ...
                    <div class="file-upload-container">
                        <label style="display:block; font-size:13px; font-weight:600; margin-bottom:8px;">
                            <i class="fas fa-paperclip" style="color:var(--secondary);"></i> Upload File Surat
                        </label>
                        ...
                        <div class="help-text" style="margin-top:8px; font-size:12px; color:var(--text-muted);">
                            <i class="fas fa-info-circle"></i> Format yang diterima: PDF, PNG, JPG | Ukuran maksimal: 5MB
                        </div>
                    </div>
                    ...
                    <div class="form-group full-width">
                        ...
                        <div class="input-wrapper">
                            <textarea name="keterangan" class="form-control" placeholder="Catatan tambahan (opsional)" style="min-height:80px;"></textarea>
                        </div>
                    </div>
